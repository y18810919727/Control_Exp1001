...
方程为微分方程，描述了泥层高度的变化率$\frac{\mathrm{d}h(t)}{\mathrm{d}t}$和底流固体浓度的变化率$\frac{\mathrm{d}c_u(t)}{\mathrm{d}t}$。
...
|  9   | $r ( t )$ | 泥层内液固质量比 |         $r(t)=\frac{\rho_{l}}{\rho_{s}}*\frac{\rho_{s}-c_a(t)}{c_a(t)}$         | 无 |    附录1   |
...
\left\{
\begin{array}
&\frac{\mathrm{d}h(t)}{\mathrm{d}t}= \frac { W ( t ) \theta } { A \rho_l}  *\frac{\rho_l}{\rho_s}\frac{-\rho_s}{c_a(t)^2}\frac{\mathrm{d}c_a(t)}{\mathrm{d}t}\\
